...
export default {
    ...
    methods: {
        ...
        loadHotBooks() {
            ...
            this.$http.get("/api/book/hot")
                .then((response) => {
                    this.hotBooks = response.results;
                })
                .catch((error) => {
        ...
        loadCollectBooks() {
            // 发送请求获取热门收藏书籍数据
            // 假设获取的数据为 collectBooks
            // this.collectBooks = collectBooks;
            this.$http.get("/api/book/collect")
                .then((response) => {
                    this.collectBooks = response.results;
                })
                .catch((error) => {
                    console.error("Error fetching collect books:", error);
                });
        },
        // 加载高分图书数据
        loadScoreBooks() {
            // 发送请求获取高分图书数据
            // 假设获取的数据为 scoreBooks
            // this.scoreBooks = scoreBooks;
            this.$http.get("/api/book/score")
                .then((response) => {
                    this.scoreBooks = response.results;
                })
                .catch((error) => {
                    console.error("Error fetching score books:", error);
                });
        },
        // 加载新书推荐书籍数据
        loadNewBooks() {
